...
export function TreatyDetailPage() {
  ...
  const runTransition = async (to: string) => {
    ...
    try {
      ...
      // Soft-limit warning: bind succeeded but a zone is above 80 % utilisation.
      // Pick the most-loaded warning zone to surface in the banner.
      ...
      // Hard-limit capacity breach: binding was blocked (HTTP 409 CAPACITY_BREACH).
      // Display the structured breach alert instead of a generic toast.
