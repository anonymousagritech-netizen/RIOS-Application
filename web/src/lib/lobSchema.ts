...
export const LOB_CLASS_GROUPS: FieldGroup[] = [
  {
    ...
    fields: [
      ...
      { key: 'pml', label: 'PML %', type: 'number', placeholder: 'e.g. 35', hint: 'Probable maximum loss' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'revenue', label: 'Annual revenue', type: 'number', placeholder: 'e.g. 500000000' },
      { key: 'employees', label: 'Employees', type: 'number', placeholder: 'e.g. 5000' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'records', label: 'Records held', type: 'number', placeholder: 'e.g. 2000000', hint: 'PII/PCI records exposed' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'fleetSize', label: 'Fleet size', type: 'number', placeholder: 'e.g. 350' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'yield', label: 'Expected yield', type: 'number', placeholder: 'e.g. 4200', hint: 'kg/ha' },
