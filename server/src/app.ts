        ...
        200: {
          ...
          properties: {
            kpis: {
              type: 'object',
              properties: {
                treaties: { type: 'integer' },
                activeTreaties: { type: 'integer' },
                parties: { type: 'integer' },
                openClaims: { type: 'integer' },
                gwpMinor: { type: 'integer', description: 'Gross written premium in minor units (cents)' },
                outstandingMinor: { type: 'integer', description: 'Total outstanding claims in minor units' },
                currency: { type: 'string' },
              },
            },
            recentTreaties: { type: 'array', items: { type: 'object' } },
            treatiesByStatus: { type: 'array', items: { type: 'object' } },
          },
        },
      },
    },
